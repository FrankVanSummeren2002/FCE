...
VertexInputDescription Vertex2D::GetVertexDescription()
{
	...
	colorAttribute.offset = offsetof(Vertex2D, uv);
...
VertexInputDescription DebugVertex::GetVertexDescription()
{
	VertexInputDescription description;
	...
	VkVertexInputBindingDescription mainBinding = {};
	mainBinding.binding = 0;
	mainBinding.stride = sizeof(DebugVertex);
	mainBinding.inputRate = VK_VERTEX_INPUT_RATE_VERTEX;
	//Position will be stored at Location 0
	VkVertexInputAttributeDescription positionAttribute = {};
	positionAttribute.binding = 0;
	positionAttribute.location = 0;
	positionAttribute.format = VK_FORMAT_R32G32B32_SFLOAT;
	positionAttribute.offset = offsetof(DebugVertex, mPos);
	//Color will be stored at Location 1
	VkVertexInputAttributeDescription colorAttribute = {};
	colorAttribute.binding = 0;
	colorAttribute.location = 1;
	colorAttribute.format = VK_FORMAT_R32G32B32A32_SFLOAT;
	colorAttribute.offset = offsetof(DebugVertex, mColor);
